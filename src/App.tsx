...
type View = 'home' | 'diagnostic' | 'practice' | 'lessons' | 'weights' | 'concepts' | 'roadsigns' | 'refreshers' | 'sources';
...
export default function App() {
  ...
  const home = <>
    ...
    <section><div className="section-head"><div><span className="eyebrow">Träna smart</span><h2>Sju vägar in</h2></div></div><div className="cards">
